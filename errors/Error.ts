...
export const RequestErrorType = {
  ...
  UNAUTHENTICATED: (additionalInformation?: string) => new RequestError(401, 'Unauthorized', additionalInformation),
  UNAUTHORIZED: (additionalInformation?: string) => new RequestError(403, 'Forbidden', additionalInformation),
}
